 ...
 */
public class ConstantRiftEffect implements BeamEffectPlugin { //WithReset {
	
	public static Color STANDARD_RIFT_COLOR = new Color(100,80,6,255);
	public static Color EXPLOSION_UNDERCOLOR = new Color(100, 0, 25, 100);
	public static Color NEGATIVE_SOURCE_COLOR = new Color(100,80,6,255);
	
	public static String CONSTANTRIFT_MINELAYER = "constantrift_minelayer";
	
	public static int MAX_RIFTS = 3;
	public static float UNUSED_RANGE_PER_SPAWN = 100;
	public static float SPAWN_SPACING = 10;
...
//		}
		...
		if (target instanceof ShipAPI && !hitShield) {
			...
			if (bounds != null) {
				...
				if (best != null) {
					Object o = Global.getSettings().getWeaponSpec(CONSTANTRIFT_MINELAYER).getProjectileSpec();
