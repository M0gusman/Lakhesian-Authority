...
public class ValarysTracking extends BaseEveryFrameCombatPlugin  {
    ...
    private static final float TARGET_REACQUIRE_ANGLE = 270f;
    ...
    public ValarysTracking(@NotNull DamagingProjectileAPI proj, CombatEntityAPI target) {
        this.proj = proj;
        this.target = target;
