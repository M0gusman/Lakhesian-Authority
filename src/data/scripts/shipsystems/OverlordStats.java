...
public class OverlordStats extends BaseShipSystemScript {
	...
	public static final float FLUX_COST_MOD = 0.5f;

	public static final Color JITTER_COLOR = new Color(90, 72, 4, 75);
	public static final Color JITTER_UNDER_COLOR = new Color(90, 72, 4, 75);
...
//			}
		...
		float WeaponFluxCost = 1f - FLUX_COST_MOD;
		stats.getEnergyWeaponFluxCostMod().modifyMult(id, WeaponFluxCost);
		stats.getBallisticWeaponFluxCostMod().modifyMult(id, WeaponFluxCost);
	}
...
//		stats.getEmpDamageTakenMult().unmodify(id);
	...
	public StatusData getStatusData(int index, State state, float effectLevel) {
		...
		if (index == 1) {
			return new StatusData("nonmissile weapon flux cost reduced", false);
		}
//		if (index == ) {
