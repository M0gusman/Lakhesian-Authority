...
public class LakhesisWeaponMod extends BaseHullMod {
	private static Map mag = new HashMap();
	static {
		mag.put(WeaponAPI.WeaponSize.SMALL, 2f);
		mag.put(WeaponAPI.WeaponSize.MEDIUM,4f);
		mag.put(WeaponAPI.WeaponSize.LARGE, 6f);
	}
